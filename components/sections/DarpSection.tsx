  ...
  return (
    <div className="pb-3 sm:pb-5 lg:pb-8">
      <Section id="darp" background="navy" className="py-20 sm:py-24 lg:py-32">
        <LongSectionContextLabel label="How DARP works" headingId="darp-title" />
        <Container className="px-6 sm:px-8 lg:px-10">
          ...
          <h2 id="darp-title" className="dt-display dt-reveal mt-5 text-center text-4xl leading-[1.05] font-semibold tracking-[-0.02em] text-white sm:text-5xl lg:text-[3.5rem]">
            How DARP works
          </h2>
